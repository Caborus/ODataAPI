...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Pokemon>(entity =>
        {
            ...
            entity.HasMany(d => d.PokemonTypes).WithMany(p => p.Pokemons)
                .UsingEntity<Dictionary<string, object>>(
                    "PokemonTypesXref",
                    r => r.HasOne<PokemonType>().WithMany()
                        .HasForeignKey("PokemonTypeId")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("fk_pokemon_type_id_types"),
                    l => l.HasOne<Pokemon>().WithMany()
                        .HasForeignKey("PokemonId")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("fk_pokemon_id_pokemon"),
                    j =>
                    {
                        j.HasKey("PokemonId", "PokemonTypeId").HasName("pokemon_types_xref_pkey");
                        j.ToTable("pokemon_types_xref");
                        j.IndexerProperty<int>("PokemonId").HasColumnName("pokemon_id");
                        j.IndexerProperty<int>("PokemonTypeId").HasColumnName("pokemon_type_id");
                    });
        });
        ...
        modelBuilder.Entity<PokemonType>(entity =>
        {
            ...
            entity.Property(e => e.Id)
                ...
                .HasColumnName("id");
            entity.Property(e => e.PokemonType1)
                .HasMaxLength(32)
